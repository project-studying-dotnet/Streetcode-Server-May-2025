            ...
            if (!dbContext.Images.Any())
            {
                ...
                if (!dbContext.Comments.Any())
                {
                    dbContext.Comments.AddRange(
                        ...
                        {
                            StreetcodeId = 1,
                            Text = "This is a great streetcode!",
                            Author = "User1",
